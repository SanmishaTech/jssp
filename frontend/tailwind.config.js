...
export default {
  ...
  theme: {
  	extend: {
  		backgroundImage: {
  			lightbg: 'radial-gradient(oklch(45.54% 0.162 281.37/0.2), oklch(45.54% 0.162 281.37/0.5))',
  			primaryaccent: 'linear-gradient(hsl(var(--primary)), hsl(var(--secondary)/0.4))',
  			secondaryaccent: 'radial-gradient(oklch(65.54% 0.162 281.37), oklch(50.07% 0.277 270.83))'
  		},
  		background: {
  		...
  		colors: {
  			...
  			primaryAccent: {
  				DEFAULT: 'linear-gradient(oklch(86.29% 0.077 185.59), oklch(88.89% 0.159 179.83))',
