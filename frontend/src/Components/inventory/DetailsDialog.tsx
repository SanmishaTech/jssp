    ...
    >
      <ModalContent>
        <ModalHeader className="flex flex-col gap-1">
          <h3 className="text-xl font-semibold text-center">Inventory Details</h3>
        ...
        <ModalBody>
          ...
          <p className="text-sm font-medium text-xl underline  mb-1">{item.four || "N/A"}</p>

            <div className="p-3 bg-muted/20 rounded-md">
              <p className="text-sm font-medium  mb-1">Institute Name: {item.one || "N/A"} </p>
              <p className="text-sm font-medium  mb-1">Purchase Date: {item.six || "N/A"}</p>
               ...
               <div className="mt-3">
                 ...
                 <div className="border rounded-md p-2 bg-muted/10 text-left shadow-sm">
                   <p className="text-sm">{item.seven || "No remarks provided"}</p>
                 </div>
               </div>
            </div>
          </div>
